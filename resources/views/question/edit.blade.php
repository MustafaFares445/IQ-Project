...
@section('content')
    ...
    <div class="modal-content rounded">
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
            ...
            <!--begin::Heading-->
            <div class="mb-13 text-center pe-auto me-sm-20">
                <!--begin::Title-->
                <h1 class="mb-10 ">تعديل بيانات السؤال</h1>
                <!--end::Title-->
            </div>
            <div class="form-group">
                <form id="kt_modal_new_hotel_form" class="form" action="{{ route('question.update' , $question->id) }}" method="POST">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label>
                            <input type="text" class="form-control form-control-solid" placeholder="ادخل نص السؤال" name="title" value="{{$question->title}}">
                        </label>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="أختر قسم السؤال" name="type_id">

                                <option value={{$question->typeId}}>{{$question->type->name}}</option>
                                @foreach(\App\Models\Type::all() as $type)
                                    @if($type->id != $question->typeId)
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" id="kt_modal_new_target_submit" class="btn btn-primary">
                            ...
                            <span class="indicator-progress">إنتظر رجاءَ</span>
