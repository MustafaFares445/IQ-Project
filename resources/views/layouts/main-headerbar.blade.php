    ...
    <div class="toolbar">
        ...
        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="page-title d-flex flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">برنامج الذكاء</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <output  class="text-muted text-hover-primary">@yield('page-name')</output>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">@yield('sub-name')</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
{{--                        @csrf--}}
{{--                        <div class = "form-group">--}}
{{--                            <input type ="submit"  class="btn btn-bg-light btn-color-muted btn-active-color-danger btn-sm px-4 me-14" value="Logout">--}}
{{--                        </div>--}}
{{--                    </form>--}}
                </div>
            </div>
