...
{{--                        <!--begin::Username-->--}}
{{--                        <output  class="text-white text-hover-primary fs-6 fw-bold">{{auth()->user()->name}}</output>--}}
{{--                        <!--end::Username-->--}}
{{--                        <!--begin::Description-->--}}
...
{{--                    <div class="me-n2">--}}
{{--                        <!--begin::Action-->--}}
{{--                        <a href="{{route('profile.edit')}}" class="btn btn-icon btn-sm btn-active-color-primary mt-n2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-overflow="true">--}}
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <div class="menu-content pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">الخيارات</span>
                    </div>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('programme.index')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">البرامج السياحية </span>
                    </a>
                </div>
            </div>
            </div>
