            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('hotel.index')}}">
                        ...
                        <span class="menu-title">الفنادق</span>
                    </a>
                </div>
                @endcan
                ...
                @can('admin')
                <div class="menu-item">
                    <a class="menu-link" href="{{route('trip.index')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('state.index')}}">
                        ...
                        <span class="menu-title">الولايات </span>
                    </a>
                </div>
                @endcan
                ...
                @can('admin')
                <div class="menu-item">
                    <a class="menu-link" href="{{route('include.index')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">التضمين </span>
                    </a>
                </div>
                @endcan
